...
import { FilePlus2, Receipt, Search, Zap, Tag, CreditCard, ChevronRight } from "lucide-react";
...
import { Package as PkgIcon, Palette, FileText, Code2, MessageSquare, Gamepad2 } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between pt-1">
        <div>
          ...
          <h1 className="text-[22px] font-bold tracking-tight text-ink leading-tight">Your deals</h1>
        </div>
        <Link
          to="/create/new"
      ...
      {liveOffers.length > 0 && (
        <section className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <p className="text-[12px] font-semibold uppercase tracking-wider text-muted">Your offers</p>
                ...
                <li key={o.id}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11.5px] text-muted">{statusLabel}</p>
                    </div>
      ...
      {actionDeals.length > 0 && (
        <section className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <p className="text-[12px] font-semibold uppercase tracking-wider text-muted">Needs action</p>
