...
import { nimiqPayDeeplink, NIMIQ_PAY_SITE } from "@/lib/host";
...
export function Nav({ scrolled }: { scrolled: boolean }) {
  ...
  >
          ...
          <nav className="hidden items-center gap-7 text-[13.5px] text-[#B9B1A2] md:flex">
          ...
          <a href={deeplink} className="btn-gold !px-4 !py-2 !text-[12.5px]">
            Launch app
      ...
      <div className="mx-auto flex max-w-site flex-col items-center justify-between gap-6 px-5 md:flex-row">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <p className="text-[14px] font-bold">XcrowHub</p>
            <p className="text-[11.5px] text-[#6F695C]">Protected payments for crypto deals</p>
          </div>
        </div>

        <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-[13px] text-[#928B7D]">
          <a href="/#how" className="transition hover:text-[#EDE7DA]">How it works</a>
        ...
        <p className="text-[12px] text-[#6F695C]">
...
export function SectionHeading({
  ...
  return (
    <div className="reveal mx-auto max-w-2xl text-center">
      ...
      <p className="mx-auto mt-3.5 max-w-xl text-[14px] leading-relaxed text-[#B9B1A2] sm:mt-4 sm:text-[15px] md:text-[16px]">
        {sub}
      </p>
    </div>
  );
