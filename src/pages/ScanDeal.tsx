      ...
      <div className="fixed inset-0 z-50 grid place-items-center bg-ink/95 px-6 text-center text-white">
        <div className="flex max-w-xs flex-col items-center gap-4">
          ...
          <div className="space-y-1">
            <h1 className="text-[15px] font-semibold">Opening payment</h1>
      ...
      <div className="fixed inset-0 z-50 flex flex-col bg-ink/95 px-6 py-5 text-white">
        ...
        <div className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <div className="mt-4 max-w-xs space-y-2">
            <h1 className="text-[15px] font-semibold">QR not recognized</h1>
            <p className="text-[11px] leading-relaxed text-white/70">{error}</p>
          </div>
