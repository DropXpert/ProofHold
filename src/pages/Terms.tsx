      ...
      <div className="mx-auto max-w-[780px] px-5 pb-24 pt-36 sm:pt-44">
        ...
        <div className="reveal prose-lp space-y-10 text-[15px] leading-relaxed text-[#C8C0B2]">
          ...
          <Section title="6. Fees">
            <p>
              XcrowHub charges zero platform fees. The buyer pays exactly the agreed deal amount.
              The seller receives exactly the agreed deal amount. We do not take a commission,
              listing fee, withdrawal fee, or any other charge now or in the future without
              updating these Terms with at least 30 days' notice.
            </p>
            <p>
