    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between pt-1">
        <div>
          ...
          <h1 className="text-[22px] font-bold tracking-tight text-ink leading-tight">Browse listings</h1>
        </div>
        {session && (
      ...
      <form onSubmit={handleSearch} className="relative">
        ...
        />
        <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md bg-accent px-2.5 py-1 text-[12px] font-medium text-white">
          Search
        </button>
      </form>
      ...
      {loading ? (
        ...
        <div className="card px-5 py-10 flex flex-col items-center gap-4 text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[12px] text-muted">Be the first to list your service.</p>
          </div>
          {session && (
          ...
          {listings.map((l) => (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <p className="text-[14px] font-semibold text-ink leading-snug line-clamp-2 flex-1">
                  {l.title}
                </p>
