  ...
  return (
    <div className="space-y-5">
      ...
      <section className="card px-5 py-5 space-y-4">
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 rounded-lg border border-edge bg-bg px-3 py-2.5 font-mono text-[15px] font-semibold tracking-[0.2em] text-ink">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2">
            <input
              readOnly
              value={link}
              className="input flex-1 text-[11px] text-muted"
      ...
      <section className="card px-5 py-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[17px] font-semibold tabular-nums leading-none text-ink">
      ...
      <section className="card px-5 py-5 space-y-3">
        <h3 className="text-[13px] font-semibold text-ink">Claimable balance</h3>
        {claimedMsg && (
          <p className="rounded-md border border-accent/30 bg-accent-soft px-3 py-2 text-[11px] text-accent-ink">
            {claimedMsg}
          </p>
        )}
        ...
        <p className="flex items-start gap-2 text-[10.5px] leading-relaxed text-muted">
