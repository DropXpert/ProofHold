...
export function TxHashLink({ hash, label }: { hash: string; label?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-md border border-edge bg-bg px-2 py-0.5 font-mono text-[11.5px] text-ink hover:bg-surface active:scale-[0.985] transition"
    >
