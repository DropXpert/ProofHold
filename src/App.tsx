...
function PublicRouteFallback() {
  return (
    <div className="lp fixed inset-0 grid place-items-center bg-[#0E1512] px-6 text-center">
      <div className="flex flex-col items-center gap-5">
        <img src="/logo-wordmark.png" alt="XcrowHub" className="h-auto w-44" />
        <div className="h-1 w-16 overflow-hidden rounded-full bg-white/10">
          <div className="h-full w-2/5 animate-pulse rounded-full bg-[#E8B964]" />
        </div>
      </div>
    </div>
  );
